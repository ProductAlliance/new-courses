...
const DomainRegexes = {
  ...
  // Uplevel's Product Alliance promo
  UPLEVEL_PA: /productuplevel\..*\/productalliance/i,
...
const ICONS = {
  ...
  cash: `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="bi bi-cash-coin" viewBox="0 0 16 16">
  ...
  file: `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="bi bi-file-text-fill" viewBox="0 0 16 16">
  ...
  mortarboard: `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="bi bi-mortarboard-fill" viewBox="0 0 16 16">
  ...
  gift: `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="bi bi-gift-fill" viewBox="0 0 16 16">
    <path d="M3 2.5a2.5 2.5 0 0 1 5 0 2.5 2.5 0 0 1 5 0v.006c0 .07 0 .27-.038.494H15a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h2.038A2.968 2.968 0 0 1 3 2.506V2.5zm1.068.5H7v-.5a1.5 1.5 0 1 0-3 0c0 .085.002.274.045.43a.522.522 0 0 0 .023.07zM9 3h2.932a.56.56 0 0 0 .023-.07c.043-.156.045-.345.045-.43a1.5 1.5 0 0 0-3 0V3zm6 4v7.5a1.5 1.5 0 0 1-1.5 1.5H9V7h6zM2.5 16A1.5 1.5 0 0 1 1 14.5V7h6v9H2.5z"/>
    </svg>`,
  document: `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="bi bi-file-text-fill" viewBox="0 0 16 16">
...
function createAndShowToast(options) {
  ...
  // it open in `_blank`.
  let isTargetAnotherPage =
    ctaURL.indexOf("#") === -1 && ctaURL.indexOf("javascript:") === -1;
  ...
  let toastOptions =
    duration && duration > 0 ? { delay: duration } : { autohide: false };
...
const FOMO_CONFIG = [
  ...
  // Uplevel with the PA promo
  {
    pageRegex: DomainRegexes.UPLEVEL_PA,
    toasts: makePaPromoToasts(
...
*/
function makeStandardCourseToasts(
  numSales,
  numDownloads,
  courseName,
  studentTitles,
...
/**
 *
 * An altered function that generates toasts advertising Uplevel's PA promo.
 *
 * @param {*} numSales
 * @param {*} numDownloads
 * @param {*} checkoutURL
 */
function makePaPromoToasts(numSales, numDownloads, checkoutURL) {
  return [
    // First, upsell the course itself
    {
      time: 10000,
      duration: 8000,
      text: `${numSales} PMs enrolled
        in Uplevel today and <strong>got Product Alliance for free</strong>.`,
      ctaURL: checkoutURL,
      icon: ICONS.mortarboard,
    },
    ...
    // reimbursement request template
    {
      time: 20000,
      duration: 0, // Make it persistent
      text: `${numDownloads} PMs downloaded our
        corporate <strong>reimbursement letter template</strong> today.`,
      ctaURL: getWebinarCtaURL(),
      icon: ICONS.cash,
    },
...
/**
  An altered function that generates toasts advertising EA's iPad/iPhone promo.
*/
function makePromoToasts(
  numSales,
  numDownloads,
  courseName,
  studentTitles,
 ...
 * iPad promotion.
 */
function makeCompanyIpadPromoConfig(
  companySlug,
  companyName,
  numSales,
  checkoutPage
 ...
 * iPhone promotion.
 */
function makeCompanyIphonePromoConfig(
  companySlug,
  companyName,
  numSales,
  checkoutPage
...
$(function () {
  ...
  FOMO_CONFIG.forEach((configObject) => {
    ...
    if (!hasMatched && configObject.pageRegex.test(window.location.href)) {
